...
const connectivity = [
  ...
  { icon: 'code', title: 'TRAE IDE', desc: 'The core development environment for vibe coding.', hoverBorder: 'hover:border-amber-400/40', iconBg: 'bg-amber-400/10', iconColor: 'text-amber-400', linkColor: 'text-amber-400', label: 'Download Tool', href: 'https://docs.trae.ai/ide/what-is-trae?_lang=en' },
  { icon: 'api', title: 'Z.ai API', desc: 'GLM model documentation and API reference.', hoverBorder: 'hover:border-emerald-400/40', iconBg: 'bg-emerald-400/10', iconColor: 'text-emerald-400', linkColor: 'text-emerald-400', label: 'Fetch Schema', href: 'https://docs.z.ai/devpack/using5.1' },
